...
export const tests_lazy_indexof: [string, IP['1'], IP['2']?][] = [
	...
	[
		'被不只是救了自己性命還給自己做不得了修行的恩人发話說要為了自己不惜被全世界盯上也要建立氏族',
		[
			'發',
		],
	],
	...
	[
		'REX幾天前发布的最新版本對包括蘇生魔術在內的各種常用魔術術式進行了大幅度改良',
		[
			'發',
		],
	],
