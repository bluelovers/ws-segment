...
const isUnset_1 = __importStar(require("../util/isUnset"));
/**
            ...
            if (w1_len === 1) {
                ...
                if (w1.w === '里') {
                    ...
                    if (((0, isUnset_1.default)(w0) || w0.p & POSTAG.D_W) && ((w2 === null || w2 === void 0 ? void 0 : w2.p) && (w2.p & POSTAG.D_N
                        ...
                        else if (!(0, isUnset_1.default)(w3 = words[i + 2])) {
                            if (w0.p & POSTAG.D_V
                                && w2.p & POSTAG.D_D
                                && w3.p & POSTAG.D_V) {
                                w1.ow = w1.w;
                    ...
                    if ((0, isUnset_1.default)(w2) || w2.p & POSTAG.D_W) {
                        w1.ow = w1.w;
                        w1.w = '麼';
                        bool = true;
                    }
