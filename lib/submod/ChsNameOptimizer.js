    ...
    doOptimize(words) {
        ...
        while (i < words.length) {
            ...
            if (this.isMergeable(word, nextword) && this.validUnknownNewWord(word.w + nextword.w)) {
                ...
                if (((_a = nextword2 === null || nextword2 === void 0 ? void 0 : nextword2.w) === null || _a === void 0 ? void 0 : _a.length) <= 2 && this.isFamilyName(word.w) && this.isFirstName(nextword.w, nextword2.w)) {
