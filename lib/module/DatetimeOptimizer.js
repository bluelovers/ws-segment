        ...
        if ((w1.p & POSTAG.A_M) > 0) {
            ...
            if (w2.w in exports.DATETIME) {
                ...
                while (true) {
                    ...
                    if (w11 && w22 && (w11.p & POSTAG.A_M) > 0 && w22.w in exports.DATETIME) {
                        len += 2;
                        nw += w11.w + w22.w;
                        ma.push(w11);
                        ma.push(w22);
...
exports._DATETIME = cjk_1.arr_cjk(exports._DATETIME);
exports.DATETIME = exports._DATETIME.reduce(function (a, b) {
    a[b] = b.length;
    return a;
}, {});
