...
import {
	tests_lazy_novel_indexof,
	tests_lazy_novel_array,
	tests_lazy_novel_base,
	tests_lazy_novel_base_not,
	tests_lazy_novel_indexof_not,
} from './res/lazy.novel';
...
describe(relative(__filename), () =>
{
	...
	// @ts-ignore
	describe(`tests_lazy_novel_indexof_not`, () =>
	{
		tests_lazy_novel_indexof_not.forEach(function (args)
		{
			it(args[0], function ()
			{
				let actual = Segment.stringify(doSegment(args[0]));
