...
遥看乡村里，依依墟里烟。皇后伊莉莎白布殊离开后宫，步出后园，准备颁布新政令。
轉換結果：
遙看鄉村裡，依依墟裡煙。皇后伊莉莎白布殊離開後宮，步出后園，準備頒布新政令。
結果並不太理想，「墟里」、「後院」、「頒佈」等都肯定轉錯了。
另外我也比較希望能用「裏」字，而不是「裡」。
至於「后宮」轉作「後宮」，雖然一般情況是對的，但這句子中反而作「后宮」（皇后伊莉莎白布殊的宮殿）可能比較準確。不過若無法按句意判斷，我寧可它都轉作「後宮」
