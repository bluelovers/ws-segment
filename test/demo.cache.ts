...
電芯容量\t5200mAh-10000mAh
品牌\tSAMSUNG三星
產地\t中國
顏色\t銀色
保固\t3個月
尺寸\t149.93 x 70.8 x 15.09 mm
重量\t234g
電池種類\t18650鋰電池
電源輸入\tDC 5V/2A
輸出電流\tDC 5V/2A
...
無線充電(快速充電, Qi無線充電, Galaxy Watch), 有線快速充電輸入及輸出 (AFC, QC2.0 max.15W)
盒內配件 無線閃充行動電源, USB Type-C充電線, QSG
   

實體規格

線材長度 0.2 m
尺寸 (寬x長x高) 149.93 x 70.8 x 15.09 mm
重量 234 g
...
輸入電壓 (快充) 9V, 12V
輸入電流(一般) 2 A
輸入電流 (快充) 1.67A (9V), 1.25A (12V)
輸出電壓 (一般) 5 V
輸出電壓 (快充) 9V, 12V
輸出電流(一般) 2 A
輸出電流 (快充) 1.67A (9V), 1.25A (12V)
Wireless Charging Output 快速充電, Qi無線充電, Galaxy Watch, Gear S3/Sport
